...
export const DataProvider = ({
  ...
  const HeadersColumn1 = [
    ...
    { field: "Barcode", value: "", placeholder: "Color", HeaderVisible: "visible", width: "100px", pattern: "" },
  ...
  const [fabyarn_Values, setFabYarn_Values] = useState([
    {
      AsptblFabYarId: "",
      Compcode: "",
      FinYear: "",
  ...
  const [fabyarn_DetValues, setFabYarn_DetValues] = useState([
    {
      SNo: 1,
      RowIndex: 0,
      AsptblFabYarDetId: 0,
  ...
  const [fabyarn_combo_Values, setFabYarn_Combo_Values] = useState([
    {
      SNo: 1,
      RowIndex: 0,
      AsptblFabYarComId: 0,
  ...
  const [fabyarn_gram_Values, setFabYarn_Gram_Values] = useState([
    {
      SNo: 1,
      RowIndex: 0,
      AsptblFabYarGraId: 0,
  ...
  const [fabyarn_yarn_Values, setFabYarn_Yarn_Values] = useState([
    {
      SNo: 1,
      RowIndex: 0,
      AsptblFabYarYarId: 0,
  ...
  const [fabyarn_pro_Values, setFabYarn_Pro_Values] = useState([
    {
      SNo: 1,
      RowIndex: 0,
      AsptblFabYarProId: 0,
