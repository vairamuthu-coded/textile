        ...
        <div className="container-fluid animate-zoom pt-0">
          <div className="row" style={{ display: `${userRights1[0].readonlys === "T" ? "block" : "none"}` }}>
            <ul className="boxShadow d-flex justify-content-end">
              <li>
                {" "}
                <button className={newButton === 1 ? "tabs active-tabs" : "tabs"} style={{ display: `${userRights1[0].news}` === "T" ? "block" : "none", backgroundColor: `${colorValue}` }} onClick={() => MenuNameMaster_New()}>
                  News
                </button>
              </li>
              <li>
                {" "}
                <button className={newButton === 1 ? "tabs active-tabs" : "tabs"} style={{ display: `${userRights1[0].saves}` === "T" ? "block" : "none", backgroundColor: `${colorValue}` }} onClick={() => MenuNameMaster_Save()}>
                  Save
                </button>
              </li>
              <li>
                {" "}
                <button
                  className={newButton === 1 ? "tabs active-tabs" : "tabs"}
                  style={{ display: `${userRights1[0].deletes}` === "T" ? "block" : "none", backgroundColor: `${colorValue}` }}
                  onClick={(e) => MenuNameMaster_Delete(menuNameValues.menunameid)}
                >
                  Delete
                </button>
              </li>
              <li>
                {" "}
                <button className={newButton === 1 ? "tabs active-tabs" : "tabs"} style={{ display: `${userRights1[0].search}` === "T" ? "block" : "none", backgroundColor: `${colorValue}` }} onClick={() => MenuNameMaster_New()}>
                  {" "}
                  Search{" "}
                </button>
              </li>
              <li>
                {" "}
                <button className={newButton === 1 ? "tabs active-tabs" : "tabs"} style={{ display: `${userRights1[0].prints}` === "T" ? "block" : "none", backgroundColor: `${colorValue}` }} onClick={() => MenuNameMaster_New()}>
                  Prints
                </button>
              </li>
              <li>
                {" "}
                <button className={newButton === 1 ? "tabs active-tabs" : "tabs"} style={{ display: `${userRights1[0].readonlys}` === "T" ? "none" : "none", backgroundColor: `${colorValue}` }} onClick={() => MenuNameMaster_New()}>
                  Readonlys
                </button>
              </li>
              <li>
                {" "}
                <button className={newButton === 1 ? "tabs active-tabs" : "tabs"} style={{ display: `${userRights1[0].treebutton}` === "T" ? "block" : "none", backgroundColor: `${colorValue}` }} onClick={(e) => MenuNameMaster_New()}>
                  TreeButton
                </button>
              </li>
              <li>
                {" "}
                <button className={newButton === 1 ? "tabs active-tabs" : "tabs"} style={{ display: `${userRights1[0].globalsearch}` === "T" ? "block" : "none", backgroundColor: `${colorValue}` }} onClick={() => MenuNameMaster_New()}>
                  {" "}
                  Globalsearch{" "}
                </button>
              </li>
              <li>
                {" "}
                <button className={newButton === 1 ? "tabs active-tabs" : "tabs"} style={{ display: `${userRights1[0].login}` === "T" ? "block" : "none", backgroundColor: `${colorValue}` }} onClick={() => MenuNameMaster_New()}>
                  Login
                </button>
              </li>
              <li>
                {" "}
                <button className={newButton === 1 ? "tabs active-tabs" : "tabs"} style={{ display: `${userRights1[0].changepassword}` === "T" ? "block" : "none", backgroundColor: `${colorValue}` }} onClick={() => MenuNameMaster_New()}>
                  Changepassword
                </button>
              </li>
              <li>
                {" "}
                <button className={newButton === 1 ? "tabs active-tabs" : "tabs"} style={{ display: `${userRights1[0].changeskin}` === "T" ? "block" : "none", backgroundColor: `${colorValue}` }} onClick={(e) => MenuNameMaster_New()}>
                  Changeskin
                </button>
              </li>
              <li>
                {" "}
                <button className={newButton === 1 ? "tabs active-tabs" : "tabs"} style={{ display: `${userRights1[0].contact}` === "T" ? "block" : "none", backgroundColor: `${colorValue}` }} onClick={() => MenuNameMaster_New()}>
                  {" "}
                  Contact{" "}
                </button>
              </li>
              <li>
                {" "}
                <button className={newButton === 1 ? "tabs active-tabs" : "tabs"} style={{ display: `${userRights1[0].pdf}` === "T" ? "block" : "none", backgroundColor: `${colorValue}` }} onClick={(e) => MenuNameMaster_New()}>
                  Pdf
                </button>
              </li>
              <li>
                {" "}
                <button className={newButton === 1 ? "tabs active-tabs" : "tabs"} style={{ display: `${userRights1[0].import}` === "T" ? "block" : "none", backgroundColor: `${colorValue}` }} onClick={() => MenuNameMaster_New()}>
                  {" "}
                  Import{" "}
                </button>
              </li>
              <li>
                {" "}
                <button className={newButton === 1 ? "tabs active-tabs" : "tabs"} style={{ display: `${userRights1[0].download}` === "T" ? "block" : "none", backgroundColor: `${colorValue}` }} onClick={() => MenuNameMaster_New()}>
                  {" "}
                  Download{" "}
                </button>
              </li>
                ...
                <div className="content active-content" style={{ backgroundColor: `${foreValue}` }}>
                  <div className="container-fluid">
                    <div className="row py-1">
                      ...
                      <input className="col-md-7" type="text" name="menunameid" readOnly value={menuNameValues.menunameid || ""} />
                    </div>
                    <div className="row">
                      <label className="col-md-4">MenuName</label>
                      <input className="col-md-7" type="text" name="menuname" ref={inputref} value={menuNameValues.menuname || ""} onChange={handleChange} />
                    </div>
                    {/* <div className='row py-1'>
                    ...
                    <div className="row pt-1">
                      ...
                      <input className="col-md-7" type="text" name="aliasname" ref={inputref} value={menuNameValues.aliasname || ""} onChange={handleChange} />
                    </div>
                    <div className="row  py-1">
                  ...
                  {menu_menuItems.length > 0 ? (
                    <div className="pt-1 ">
                      <DataTable
                        ...
                        comments={menu_menuItems}
                        setComments={setMenuItems}
                        foreValue={foreValue}
                        searches={menuMaster_Search}
                        setSearches={setMenuMaster_Search}
