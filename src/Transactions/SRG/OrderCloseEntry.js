  ...
  return (
    <div>
      <TextInput
        ...
        onKeyDown={() => refs.current[1]?.focus()}
        className1="col-md-2"
        stylecolor={`${foreValue}`}
        className="col-md-2"
        title={"Pono"}
        id="Pono"
        value={defectValues.Asptblcutpanretid || ""}
        onChange={handleChange}
        barValues={defectValues}
        setBarValues={setDefectValues}
        name="Pono"
        placeholder=""
        name1="PoNo"
        visible={true}
      ...
      <TextInput
        ...
        onKeyDown={() => refs.current[2]?.focus()}
        className1="col-md-1"
        className="col-md-2"
        id="OrderNo"
        name="OrderNo"
        placeholder=""
        value={defectValues.Orderno || ""}
        onChange={handleChange}
        barValues={defectValues}
        setBarValues={setDefectValues}
        name1="Erp-OrderNo"
...
/> */}
      ...
      <select ref={(el) => (refs.current[2] = el)} onKeyDown={(e) => e.key === "Enter" && refs.current[3]?.focus()}>
        <option></option>
