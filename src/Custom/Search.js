...
const Search = ({ colorValue,stylecolor, searchs, setsearchs, SearchLable1, SearchLable2, SearchLable3 ,searchCompCode,
  ChangeValues,handleChange,searchUserName}) => {
 ...
 : ''}
        ...
        {SearchLable3 !== "" ?   <select className='col-md-3' name='username' value={ChangeValues.username || ""} onChange={handleChange} >
        <option></option>
                      {
                        searchUserName !== null &&
