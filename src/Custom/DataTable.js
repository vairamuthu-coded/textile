...
const DataTable = ({heights,colorValue,headers,comments,setComments,searches,setSearches,
...
{ITEM_PER_PAGE>0 && comments.length>0  &&
    ...
    <div className='container-fluid' >
      ...
      <Table  mode={mode} foreValue={foreValue} heights={heights} setCheckchild={setCheckchild} checkchild={checkchild} checkall={checkall}  setCheckAll={setCheckAll} onSorting={(field,order)=>setSorting({field,order})} colorValue={colorValue} FilterSearch={commentsData} EditData={EditData} columns={headers} />
  </div>
