...
const Table = ({ FilterSearch, EditData, columns, heights, onSorting, setCheckAll, checkchild, setCheckchild, checkall, mode, foreValue }) => {
  return (
    <div className="container-fluid" style={{ height: `${heights}`, overflow: "auto", fontFamily: "var(--bs-font-roboto)" }}>
      <table className="table table-responsive table-striped table-hover" data-bs-theme={mode}>
        ...
        <tbody style={{ fontFamily: "var(--bs-font-roboto)" }}>
